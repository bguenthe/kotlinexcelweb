...
//}
//
//fun createNewEntries(entries: List<NewEntry>, companyNames: List<String>): Map<String, NewEntry> {
...
//}
//
//fun addYearSum(entry: NewEntry, newEntry: NewEntry?) : NewEntry {
...
//}
//
//fun read(sheet :Sheet): List<NewEntry> {
//    val iterator = sheet.rowIterator()
//    //var prevCompanyName = ""
//    //var prevDate : String = ""
//    //var prevPartyType : String = ""
//    val entryList = ArrayList<NewEntry>()
